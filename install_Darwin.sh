...
then
    ...
    checkInstall gzip "gzip" "https://www.gnu.org/software/gzip/"
    ...
    checkInstall unzip "unzip" "https://infozip.sourceforge.io/UnZip.html"
    ...
    checkCask android-tool "Android Tool" "AndroidTool.app" "https://github.com/mortenjust/androidtool-mac"
    checkCask atom "Atom" "Atom.app" "https://atom.io/"
    checkCask box-sync "Box Sync" "Box Sync.app" "https://www.box.com/"
    checkCask caffeine "Caffeine" "Caffeine.app" "https://intelliscapesolutions.com/apps/caffeine"
    ...
    checkCask day-o "Day-O" "Day-O.app" "https://shauninman.com/archive/2020/04/08/day_o_mac_menu_bar_clock_for_catalina"
    ...
    checkCask virtualbox "VirtualBox" "VirtualBox.app" "https://www.virtualbox.org/"
